...
class Util {
    static detect_framework() {
        ...
        else if (Util.is_defined(window.r)) framework11 = new (0, $jYzCB.Xtk)(window.r);
        else if (Util.is_defined(window.OpenSeadragon)) framework11 = new (0, $7Srn3.OpenSeaDragon)(window.OpenSeadragon);
        else if (Util.is_defined(window.papayaContainers)) framework11 = new (0, $3okZG.Papaya)(window.papayaContainers);
    ...
    static async load_script(url, callback) {
        ...
        // });
        // introducing hack to make it work for openneuro
        if (window.global === "undefined") window.Object.defineProperty(window.Object.prototype, "global", {
            get () {
                return window;
            },
            set (newGlobal11) {
