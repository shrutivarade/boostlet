...
class $febea0d4681e2ae0$export$1ec7e9f19103cb25 extends (0, $bsgU1.Framework) {
    ...
    select_box(callback) {
        ...
        BoxCraft.createDraggableBBox(canvas, function(topleft, bottomright) {
            ...
            //   topleft.x = topleft.x * window.devicePixelRatio
            //   topleft.y = topleft.y * window.devicePixelRatio
            //   bottomright.x = bottomright.x * window.devicePixelRatio
            //   bottomright.y = bottomright.y * window.devicePixelRatio
            // }
            // console.log("Inside Draggable BBox",topleft, bottomright);
